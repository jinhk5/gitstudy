...
public class SelectProductByFemaleCategoryCommand implements MainCommand {
	...
	public void execute(SqlSession sqlSession, Model model) {
		...
		ArrayList<ProductDTO> list = cDAO.selectProductByFemaleCategory1(pCategory);
		...
		list = cDAO.selectProductByFemaleCategory2(pCategory, beginRecord, endRecord);
