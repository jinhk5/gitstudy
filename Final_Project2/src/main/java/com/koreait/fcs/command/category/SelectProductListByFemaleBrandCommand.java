...
public class SelectProductListByFemaleBrandCommand implements MainCommand {
	...
	public void execute(SqlSession sqlSession, Model model) {
		...
		ArrayList<ProductDTO> list = cDAO.selectProductListByFemaleBrandCommand1(pCompany);
		...
		list = cDAO.selectProductListByFemaleBrandCommand2(pCompany, beginRecord, endRecord);
		...
		model.addAttribute("selectList", "selectProductByFemaleBrand");
