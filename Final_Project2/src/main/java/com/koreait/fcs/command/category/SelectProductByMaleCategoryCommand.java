...
public class SelectProductByMaleCategoryCommand implements MainCommand {
	...
	public void execute(SqlSession sqlSession, Model model) {
		...
		ArrayList<ProductDTO> list = cDAO.selectProductByMaleCategory1(pCategory);
		...
		list = cDAO.selectProductByMaleCategory2(pCategory, beginRecord, endRecord);
